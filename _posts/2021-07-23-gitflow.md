...
- You are now on branch 'develop'
```
hotfix.txt နဲ့ hb ဆိုပြီး tag တစ်ခုကိုတွေ့ရမှာဖြစ်ပါတယ်။ github ထဲ push ချင်ရင်တော့ git push နဲ့ push လုပ်ပေးလိုက်ပါ။
